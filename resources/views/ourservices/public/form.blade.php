...
<div class="col-md-12">
				...
				{!! Form::hidden('id', $row['id']) !!}					
						...
						<div class="icon-preview preview-upload">
							{!! SiteHelpers::showUploadedFile( $row["icon"],"/uploads/images/services/") !!}
						</div>
						...
						<div class="image-preview preview-upload">
						 ...
						 >{{ $row['details'] }}</textarea> 
									  ...
									  <div class="form-group row  " >
										<label for="Short Number" class=" control-label col-md-4 text-left"> Short Number </label>
										<div class="col-md-6">
										  <input  type='text' name='short_number' id='short_number' value='{{ $row['short_number'] }}' 
						     class='form-control form-control-sm ' /> 
										 </div> 
										 <div class="col-md-2">
   ...
   <script type="text/javascript">
	$(document).ready(function() { 
		...
		$("#status").jCombo("{!! url('ourservices/comboselect?filter=tb_status:id:status') !!}",
