...
<div class="col-md-12">
						<fieldset><legend> Our Teams</legend>
				{!! Form::hidden('id', $row['id']) !!}					
						...
						<div class="image-preview preview-upload">
							{!! SiteHelpers::showUploadedFile( $row["image"],"/uploads/images/teams/") !!}
						</div>
   ...
   <script type="text/javascript">
	$(document).ready(function() { 
		...
		$("#status").jCombo("{!! url('ourteams/comboselect?filter=tb_status:id:status') !!}",
